...
int main(int argc, char * argv[])
{
  ...
  typedef itk::NumberOfChildrenComponentTreeFilter< TreeType > ComputeType;
  ComputeType::Pointer compute = ComputeType::New();
  compute->SetInput( maxtree->GetOutput() );

  typedef itk::ShiftComponentTreeFilter< TreeType > FilterType;
  FilterType::Pointer filter = FilterType::New();
  filter->SetInput( compute->GetOutput() );
